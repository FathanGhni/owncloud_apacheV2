...
# Install other PHP extensions required by OwnCloud
RUN docker-php-ext-install pdo_mysql mysqli mbstring exif zip pcntl bcmath calendar intl gettext opcache sockets xml
